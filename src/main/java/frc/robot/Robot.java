...
public class Robot extends TimedRobot {
  ...
  private final WPI_VictorSPX m_lf = new WPI_VictorSPX(1);
  private final WPI_VictorSPX m_lb = new WPI_VictorSPX(2);
  private final WPI_VictorSPX m_rf = new WPI_VictorSPX(3);
  private final WPI_VictorSPX m_rb = new WPI_VictorSPX(4);
  private final WPI_VictorSPX m_sh = new WPI_VictorSPX(5);
  private final WPI_VictorSPX m_in = new WPI_VictorSPX(6);
